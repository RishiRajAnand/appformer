 ...
 */
public interface RestWorkbenchEnties {
     ...
     */
    List<String> getAllPerpective();

    /**
     * Returns list of all the workbench features and their permissions.
     *
     * @return List of string containing name of features and permission.
     */
    List<String> getAllWorkbenchFeatures();
}
