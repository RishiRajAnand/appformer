...
public class AssignRolesToUsersCmd extends AbstractJobCommand {

    public AssignRolesToUsersCmd(JobRequestHelper jobRequestHelper, JobResultManager jobResultManager, Map<String, Object> context) {
    ...
    protected JobResult internalExecute(JobRequest request) throws Exception {
        ...
        AssignRolesToUserJobRequest jobRequest = (AssignRolesToUserJobRequest) request;

        JobResult result = null;
        try {
            result = helper.assignRolesToUser(jobRequest.getJobId(),
