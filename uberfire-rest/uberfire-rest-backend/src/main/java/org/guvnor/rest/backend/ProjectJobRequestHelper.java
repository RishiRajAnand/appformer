...
@ApplicationScoped
public class ProjectJobRequestHelper implements  JobRequestHelper {

    private static final Logger logger = LoggerFactory.getLogger(ProjectJobRequestHelper.class);
